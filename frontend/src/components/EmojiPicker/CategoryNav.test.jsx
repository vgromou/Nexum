...
describe('CategoryNav', () => {
    ...
    describe('Rendering', () => {
        it('should render category navigation container', () => {
            ...
            expect(container.querySelector('.category-nav')).toBeInTheDocument();
        });

        it('should render button for each category', () => {
            const { container } = render(<CategoryNav {...defaultProps} />);
            const buttons = container.querySelectorAll('.category-nav-item');
    ...
    describe('Active state', () => {
        it('should mark the active category button', () => {
            ...
            const activeButtons = container.querySelectorAll('.category-nav-item.active');
        ...
        it('should update active state when prop changes', () => {
            ...
            let activeButton = container.querySelector('.category-nav-item.active');
            expect(activeButton).toHaveAttribute('title', 'People');

            rerender(<CategoryNav {...defaultProps} activeCategory="food" />);

            activeButton = container.querySelector('.category-nav-item.active');
